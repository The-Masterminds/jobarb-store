/******/ (() => { // webpackBootstrap
/*!************************************************!*\
  !*** ./platform/themes/iori/assets/js/main.js ***!
  \************************************************/
var IoriTheme = IoriTheme || {};
window.ioriTheme = IoriTheme;
IoriTheme.showError = function (message) {
  toastr.error(message);
};
IoriTheme.showSuccess = function (message) {
  toastr.success(message);
};
IoriTheme.handleError = function (data) {
...
IoriTheme.handleValidationError = function (errors) {
  var message = '';
...
(function ($) {
  ...
  function showMonthPrice() {
    var boxPrice = $('.price-plan').find('.box-price');
    var priceMonths = boxPrice.find('.month_price');
    var priceYears = boxPrice.find('.year_price');
    priceMonths.each(function (i, e) {
      $(e).show();
    });
    priceYears.each(function (i, e) {
      $(e).hide();
    });
  }
