@props([
  'href' => null,
  'variant' => 'default', // variants: default, destructive, outline, secondary, ghost, link
  'size' => 'default',     // sizes: default, sm, lg, icon
  'asChild' => false,
])
...
@php
  ...
  $class = "$base " . (isset($variants[$variant]) ? $variants[$variant] : $variants['default']) . " " . (isset($sizes[$size]) ? $sizes[$size] : $sizes['default']) . " " . ($attributes->get('class') ? $attributes->get('class') : '');
